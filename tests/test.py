...
def test(src, level=1):
    ...
    print "compressed %6d -> %6d (with header)" % (len(src), len(c))
...
def main(args):
    ...
    testRaw("aaaaaaaaaaaaaaaaaaaaaaaa")
    test("abcabcabcabcabcabcabcabc")
    testRaw("abcabcabcabcabcabcabcabc")
    test("abcabcabcabcabcabcabcabc", level=9)
    testRaw("abcabcabcabcabcabcabcabc", level=9)
    test(" " * 131072)
    testRaw(" " * 131072)
    test("")
    testRaw("")
